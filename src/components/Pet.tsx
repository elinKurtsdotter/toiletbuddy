import { PET_OPTIONS, EVOLUTION_EMOJI, getStageInfo } from "@/lib/pet";
import type { Mood, EvolutionStage } from "@/lib/pet";
import type { AppState, PetSpecies } from "@/lib/storage";
...
interface PetProps {
  ...
  getStageInfo?: ReturnType<typeof getStageInfo>;
  appState?: AppState; // Pass full state for mood calculations if needed
}
...
export function Pet({
  ...
  console.log("appstate.maxEv", appState);
    ...
    <div className="relative w-full">
      <div
        ...
        style={{
          ...
          borderColor: mood === "sad" ? "hsl(0 0% 50%)" : opt.color,
        }}>
        <span
          className={cn(
